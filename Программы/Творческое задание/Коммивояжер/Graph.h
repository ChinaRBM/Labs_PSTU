...
int amountVerts;//Изменяемая переменная для кол-ва вершин
...
Graph makeGraph()
{
	...
	cout << "Кол-во вершин: "; cin >> amountVerts; cout << endl;//Ввод кол-ва вершин
	cout << "Кол-во рёбер: "; cin >> amountEdges; cout << endl;//Ввод кол-ва рёбер
	...
	{
		cout << "Начальная верщина: "; cin >> sourceVertex; cout << endl;//Ввод начальной вершины
...
void mouseClick(int btn, int stat, int x, int y)//Функция для действий прик клике мыши
{
	if (stat == GLUT_DOWN) //Проверка на нажатие
	{
		...
		if (x > 0 && x < 150 && y > 680 && y < 710)//Проверка на координаты положения мыши
		{
			...
			cout << "Введите вершину: "; cin >> sourceVertex; cout << endl;//Ввод номера вершины для удаления
